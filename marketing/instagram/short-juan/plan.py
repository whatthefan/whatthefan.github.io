...
sfx = [
    (E_ + 'woah-drop.mp3', T(0) - .05, .7),
    (E_ + 'camera-shutter.mp3', T(0, .1), .35),
    (E_ + 'ding.mp3', palabra(1, 'menos'), .35),
    sw(T(2), .3),
    sw(T(4), .35),
    (E_ + 'mouse-click.mp3', palabra(4, 'restaurantes'), .5), (E_ + 'mouse-click.mp3', palabra(4, 'bares'), .5), (E_ + 'mouse-click.mp3', palabra(4, 'comercios'), .5),
    sw(T(5), .3),
    sw(T(9), .35),
    (E_ + 'arrow-swoosh-2.mp3', palabra(10, 'acercar') - .15, .35),
    (E_ + 'woah-drop.mp3', palabra(11, 'BOOM') - .08, .75),
    sw(T(12), .35),
    (E_ + 'mac-typing.mp3', T(12, 2.2), .3),
    sw(T(14), .3),
    sw(T(15), .35),
    (E_ + 'mouse-click.mp3', palabra(15, 'descargar') + .35, .45), (E_ + 'mouse-click.mp3', palabra(15, 'app') + .35, .45), (E_ + 'mouse-click.mp3', palabra(15, 'buscarte') + .35, .45),
    (E_ + 'camera-screenshot.mp3', T(17, .15), .4),
    (E_ + 'metallic-riser.mp3', palabra(18, 'tres') - 1.3, .35),
    (E_ + 'cinematic-impact.mp3', palabra(18, 'tres'), .5),
    sw(T(19), .35),
    (E_ + 'camera-shutter.mp3', T(19, .1), .3),
    (E_ + 'ding.mp3', palabra(20, 'gratis'), .4),
    sw(T(21), .35),
    sw(T(24), .35),
    (E_ + 'mouse-click.mp3', palabra(24, 'único') + .3, .6),
    sw(T(25), .35),
    sw(T(26), .3),
    (E_ + 'punch-riser.mp3', T(28) - 1.1, .3),
    sw(T(28), .35),
    (E_ + 'mac-typing.mp3', T(28, .25), .3),
    (E_ + 'mouse-click.mp3', T(28, 1.0), .6),
]
