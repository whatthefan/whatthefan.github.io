...
export async function onRequest(context) {
  ...
  try {
    ...
    /* Fuera lo que no son pedidos, aunque viva en el mismo almacén:

         id-...   el índice que permite reconocer un pedido que ya había
                  para actualizarlo en vez de duplicarlo
